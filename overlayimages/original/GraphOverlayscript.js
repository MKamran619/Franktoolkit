  ...
  loadBtns.forEach((el, i) => {
    ...
    el.addEventListener("change", function(evt) {
      ...
      if (el.id === "file-1") {
        ...
        document.getElementsByTagName('body')[0].insertAdjacentElement('beforeend',slider);
        document.getElementsByTagName('body')[0].insertAdjacentElement('beforeend',sliderOpacity);
